...
| servers.charServer.resources.limits.cpu | string | `"1"` |  |
...
| servers.loginServer.resources.limits.cpu | string | `"1"` |  |
...
| servers.mapServer.resources.limits.cpu | string | `"1"` |  |
...
| servers.proxyServer.resources.limits.cpu | string | `"1"` |  |
...
| servers.webServer.resources.limits.cpu | string | `"1"` |  |
